				...
				<div id="v_geral" class="col-md-9">
                    ...
                    <tbody>
					  ...
					  <tr>
                        ...
                        <td>
							<?php echo "************";?>
							<button data-balloon-length="large" data-balloon="Ao clicares no butao uma senha sera gerada aleatoria e enviada para o email do utilizador" data-balloon-pos="up" class="btn btn-default btn-xs" onclick="gerar_s(<?php echo $registo39['id'] ?>)">Gerar senha</button>
						</td>
                      </tr>
                      <tr>
                        <td><b>Email</b></td>
