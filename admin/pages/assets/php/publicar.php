<?php
	...
	if($_POST['titulo'] == ""){
		...
		$INS1 = "INSERT INTO noticias (titulo,descricao,desshort,imagem,data) VALUES ('{$_POST['titulo']}','{$_POST['descricao']}','{$_POST['desshort']}','assets/img/{$_FILES['image']['name']}','" .  date("Y-m-d") . "')";
