           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<?php
					...
					$SQL1 = "SELECT * FROM users WHERE nome='manito'";
	
					$resultado1 = mysql_query($SQL1,$LIGA);
					
					$registo1 = mysql_fetch_array($resultado1);
					
					echo "<span id=\"gallery\"><a href=\"{$registo1['imagem']}\"><img src=\"{$registo1['imagem']}\" class=\"user-image img-responsive\"/></a></span>";
				...
				?>
					...
					<li>
                        <a class="active-menu" href="testes.php"><i class="fa fa-dashboard fa-3x"></i> Testes</a>
                    </li>
                    <li>
                        <a class=""  href="index.html"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                     <li>
