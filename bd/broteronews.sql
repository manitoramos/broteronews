...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2017 at 12:45 PM
...
INSERT INTO `acesso` (`id`, `acesso`) VALUES
(1, 'Membro'),
(2, 'Editor'),
(3, 'Admin');
...
INSERT INTO `noticias` (`id`, `titulo`, `descricao`, `desshort`, `imagem`, `autor`, `data`, `s_noticia`) VALUES
...
(2, 'Alex', 'agcseabra@gmail.com', '15c00bd44df43821911916e60a7f16010b7ee679', 'Alexandre Seabra', 2, '', '', '0000-00-00', '0000-00-00', 1, 1),
(4, 'manitotest', 'teste@manito.com', '15c00bd44df43821911916e60a7f16010b7ee679', 'tiagoteste', 1, 'assets/img-perfil/2091065caracal.jpg', 'masculino', '0000-00-00', '0000-00-00', 1, 1),
...
--
ALTER TABLE `comentarios`
  MODIFY `sku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
